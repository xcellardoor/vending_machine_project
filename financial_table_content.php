...
if (isset($_REQUEST["financial_sort_by_dropdown"]) && ($_REQUEST["financial_sort_by_dropdown"] == 'popularity')) {
    ...
    $reply = "<table id='financial_table' class='tablesorter'><thead><tr><th colspan='4'>All Time Profit: $all_time_cash</th></tr><tr><th>Product Name</th><th>Amount Sold</th></tr></thead><tbody>";
...
if ((isset($_REQUEST["between_dates_older_date"])) & (isset($_REQUEST["between_dates_newer_date"]))) {
